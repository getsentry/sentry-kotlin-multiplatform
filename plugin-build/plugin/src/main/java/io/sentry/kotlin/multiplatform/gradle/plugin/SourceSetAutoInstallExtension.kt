...
abstract class SourceSetAutoInstallExtension
@Inject
constructor(project: Project) {
    private val objects = project.objects

    /**
     * Enable auto-installation of the Sentry Kotlin Multiplatform SDK dependency in the commonMain source set.
     *
     * Defaults to true.
     */
     ...
     */
    val sentryKmpVersion: Property<String> = objects.property(String::class.java)
