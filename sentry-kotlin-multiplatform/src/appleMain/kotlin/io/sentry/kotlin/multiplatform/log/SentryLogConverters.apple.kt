 ...
 */
@Suppress("MagicNumber")
internal fun SentryLogLevel.toCocoaSentryLogLevel(): CocoaSentryLogLevel =
    when (this) {
 ...
 */
internal fun CocoaSentryLog.toKmpSentryLog(): SentryLog =
    SentryLog(
 ...
 */
internal fun CocoaSentryLog.updateFrom(
    kmpLog: SentryLog,
    ...
    modifiedKmpAttributes.forEach { (key, attrValue) ->
        mergedAttributes[key] =
            when (attrValue) {
                ...
                is SentryAttributeValue.BooleanValue ->
                    SentryStructuredLogAttribute(boolean = attrValue.value as Boolean)
            }
    }
