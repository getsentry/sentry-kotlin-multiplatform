...
/**
 * The Scope holds useful information that should be sent along with the event. For instance
 * contexts or breadcrumbs are stored on the scope.
 *
 * Users should not need to implement this interface instead the Scope should be provided by the
 * SDK. Different platforms have specific scope providers that are used internally:
