...
public expect enum class SpanStatus2 {
    /** Not an error, returned on success.  */
    OK,
    ...
    public companion object {
         ...
         * @return span status equivalent of http status code or null if not found
         */
        public fun fromHttpStatusCode(httpStatusCode: Int): SpanStatus2?
         ...
         * @return span status equivalent of http status code or defaultStatus if not found
         */
        public fun fromHttpStatusCode(httpStatusCode: Int?, defaultStatus: SpanStatus2): SpanStatus2?
    }
}