...
public abstract class SentryBaseEvent(
   ...
   *
   * This string is freeform and not set by default. A release can be associated with more than one
   ...
   *
   * A string representing the platform the SDK is submitting from. This will be used by the Sentry
   * interface to customize various components in the interface, but also to enter or skip
